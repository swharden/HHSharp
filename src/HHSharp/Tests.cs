    ...
    public class Tests
    {
        ...
        public void VerifySimulationValues()
        {
            ...
            for (int i = 0; i < 5_000; i++)
                model.Iterate(stimulusCurrent: 20, deltaTms: 0.01);
